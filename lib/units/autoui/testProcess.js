...
function test(options, taskid) {
  ...
  rpldata.logs = {
    ...
    ,'report' : reportPath
    ,'logs' : logsPath
    ,'monitorAppLogPath' : monitorAppLogPath
  }
  ...
  testutil.createadb({host:host}, serial, log)
    ...
    .then(function () {
      ...
      if(accountFilePath){
        ...
        args = util.format('env:%s,game_id:%s', testEnv, game_id)
    ...
    .then(function () {
      ...
      testutil.monitorApp(adb, serial, monitorAppLogPath, log)
      // openLogcat()
        ...
        exec('mv '+runReportPath+'* '+reportPath, function (err, stdout, stderr) {
          if(err){
            ...
            if(parseResult.error){
              ...
              rpldata.result = {errorType: 'ui auto test failed', reason: parseResult.error}
            }else{
    ...
    .finally(function () {
      ...
      adb.shell(serial, startuiautomatorCmd)
        ...
        .then(function () {
          ...
          return testutil.uninstallAPK(adb, serial, testBundlePkg, log)
            .catch(function (err) {
        ...
        .finally(function(){
          ...
          fs.appendFileSync(appiumLogPath, appiumLogData)
          appiumLogData = ''
        ...
        .then(function () {
          ...
          function execCmd(cmd){
            ...
            .then(function (startAppiumStream) {
              ...
              /* startAppiumStream.on('end', function(code, signal){
                log.debug('appium end ')
           
              })

              startAppiumStream.on('exit', function(code, signal){
                log.debug('appium exit ')
