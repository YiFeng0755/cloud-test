...
module.exports = function (req, taskid) {
  ...
  var taskListData = {
    ...
    memo: req.body.memo,
    cases: req.body.cases?req.body.cases:[ 'd12089c54c0b1eef676093d01dbe3364',
  'c68fbc66038d3f0d8751692ca354edfb' ],
    ...
    if (apkinfo.apkDecompilePath && fs.existsSync(apkinfo.apkDecompilePath)) {
      ...
      if (req.body.serials.length > 0) {
        var taskData = {
          taskid: taskid,
          serials: req.body.serials,
          cases: req.body.cases?req.body.cases:taskListData.cases,
          projectName: req.body.projectName,
          options: data,
          testType: "travelTest",
          testEnv: req.body.testEnv
