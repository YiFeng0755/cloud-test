/**
 * Created by YoungLiu on 2018/4/18.
 */
...
router.get('/loadTestSuite', function (req, res) {
    ...
    exec('svn update --no-auth-cache --username '+username+' --password '+password, {cwd: '/var/stf/testproject2'}, function (error, stdout, stderr) {
         log.info('svn update --no-auth-cache --username '+username+'--password '+password)
        /*while (true) {
