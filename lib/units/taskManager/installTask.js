    ...
    function runTask(host, taskInfo) {
      ...
      testutil.wakeUpPhone(serial, adb, log)
                    ...
                    .then(function () {
                      return adb.install(serial, apkPath)
                        ...
                        .catch(function (er) {
                          ...
                          rpldata.statusCode = 1
                          if (er.code) {
                            rpldata.result = {errorType: 'install failed', reson: er.code}
                          } else {
                            rpldata.result = {errorType: 'install failed', reson: er.toString()}
                          }
        ...
        .catch(function(err){
          ...
          rpldata.status = 'fail'
          rpldata.statusCode = 1
          rpldata.result = {errorType: 'install failed', reson: 'wake up phone error'}
          cb(err, rpldata)
          // installTaskFinish = true 
        })
        .finally(function(){
