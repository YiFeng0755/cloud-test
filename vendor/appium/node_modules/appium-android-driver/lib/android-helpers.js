...
import TestBundle from 'appium-android-testbundle'
...
helpers.initUnicodeKeyboard = async function (adb, opts) {
...
helpers.initDevice = async function (adb, opts) {
  ...
  if (opts.startLogcat) {
    logger.debug("openning logcat")
    await adb.startLogcat();
  }
  let defaultIME;
  if (opts.unicodeKeyboard) {
    defaultIME = await helpers.initUnicodeKeyboard(adb, opts);
  }
  if (!opts.avd) {
